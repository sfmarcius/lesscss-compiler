Custom LESS CSS Maven Plugin
==============================

A custom LessCSS maven plugin based on the work of Marcel Overdijk.

The main change is added support to @import-once
